...
export default defineConfig(
  withMermaid({
    ...
    head: [
      ...
      ["meta", { property: "og:image", content: "https://cdn.tensor-fusion.ai/tensor-fusion.png" }],
      ...
      ["meta", { property: "twitter:image", content: "https://cdn.tensor-fusion.ai/tensor-fusion.png" }],
      ["meta", { name: "twitter:card", content: "summary_large_image" }],
      ['meta', { name: 'robots', content: 'index, follow' }],
      ["link", { rel: "icon", href: "/favicon.ico" }],
      ["link", { rel: "robots", href: "/robots.txt" }],
      ["link", { rel: "apple-touch-icon", href: "https://cdn.tensor-fusion.ai/tensor-fusion.png" }],
